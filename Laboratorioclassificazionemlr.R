...
#controllo sui clienti che non ci sono più nel 2000
sum(is.na(Online0))
sum(is.na(Profit0))
...
# Dividiamo il dataset in training and testing
set.seed(100)
...
# Gestione outliers (rimozione profitti sopra i 50000)
...
#tipo di valutazione iperparametri: resampling 
...
#prendiamo allora i parametri di controllo migliori
## minsplit = 8,
##minbucket = 2,
##maxdepth = 6,
##maxcompete=6,
...
#?  migliorata di molto la previsione dei 'Gone'
